  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#home">
            <h1><span>i</span>nfo<span>C</span>ov-19</h1>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
    ...
    <div class="tracking container">
      ...
      <div class="tracking-bottom">
        <div class="tracking-item">
          ...
          <div>
            <img class="img-emot" src="img/emoji-04.png" alt="" heigth="100" width="100">
          </div>
        </div>
        <div class="tracking-item">
          <div class="tracking-info">
          ...
          <div>
            <img class="img-emot" src="img/emoji-01.png" alt="" heigth="100" width="100">
          </div>
        </div>
        <div class="tracking-item">
          <div class="tracking-info">
          ...
          <div>
            <img class="img-emot" src="img/emoji-03.png" alt="" heigth="100" width="100">
          </div>
        </div>
      </div>
